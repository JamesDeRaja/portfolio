  ...
  return (
    <div className="mt-4 grid gap-4 md:grid-cols-2">
      <div className="min-w-0 space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
        <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500">Setup</p>
      ...
      <div className="min-w-0 space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
        <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500">Analysis</p>
